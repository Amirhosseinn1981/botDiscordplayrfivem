...
const token = 'INDSÆT DISCORD TOKEN HER'; //Dette er discord bottens token som den skal bruge til at logge ind med
...
function activity(){ // laver funktionen activity
    setTimeout(() => { // laver et loop
        fivereborn.query("45.81.16.30","30120", (err, data) => { // starter fivereborn event, 45.81.16.30:30120
